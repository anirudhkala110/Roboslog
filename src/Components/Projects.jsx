                        ...
                        <div className="row">
                            <div className="col-lg-6 col-md-6 col-sm-12 col-12">
                                <div className="banner-section-content">
                                    <h1 className="text-white" data-aos="fade-up">Projects</h1>
                                    <p className="text-white" data-aos="fade-right">Our Team has build so many projects according to the requirement of the Clients. Some of them are shown below.</p>
                            ...
                            <div className="col-lg-6 col-md-6 col-sm-12 col-12">
                                <div className="banner_image position-relative p-3">
                                    <figure className="banner_main_image mb-0 left_right_shape" style={{ marginTop: '80px' }}>
                                    ...
                                    <figure className="banner_image_bottom_shape mb-0 position-absolute top_bottom_shape">
                                        <img src="./assets/images/sub_banner_image_bottom_shape.png" alt="" className="img-fluid" style={{ marginLeft: "", marginTop: "" }} />
                                    </figure>
                                </div>
                            </div>
                        </div>
