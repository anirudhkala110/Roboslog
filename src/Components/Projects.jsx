                    ...
                    <div>
                        {
                            projects.map((data, idx) =>
                            (
                                <div id={`${data.target}`} className="collapse px-4 rounded-2 me-5" aria-labelledby="headingSix" style={{ position: "fixed",background:"#040b2b", zIndex: '600', maxHeight: '600px', maxWidth: '', top: '50px', left: '50px', right: "0px", overflow: 'auto', boxShadow: 'rgb(0 0 0 / 77%) 0px 0px 8000px 4000px' }} key={idx}>
